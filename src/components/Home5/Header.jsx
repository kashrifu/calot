  ...
  return (
    <header className={`${state.scrollY > 10 ?"sticky":""} header-area style-5`}>
      <div className="header-logo d-lg-none d-flex">
        <Link legacyBehavior href="/"><a><img alt="image" className="img-fluid" src="assets/img/green-logo.svg" /></a></Link>
      </div>
      <div className={`main-menu ${state.isSidebarOpen ? "show-menu" : ""}`}>
        <div className="mobile-logo-area d-lg-none d-flex justify-content-between align-items-center">
          <div className="mobile-logo-wrap">
            <Link legacyBehavior href="/"><a><img alt="image" src="assets/img/green-logo.svg" /></a></Link>
          </div>
        </div>
        <ul className="menu-list">
          <li className={`menu-item-has-children ${ currentRoute === "/" ? "active" : ""}`}>
              ...
              <ul className={`sub-menu ${ state.activeMenu === "home-one" ? "d-block" : ""}`}>
                ...
                <li><Link legacyBehavior href="/index5"><a className={ currentRoute === "/index5" ? "active" : ""}>Home 05</a></Link></li>
