                ...
                <SwiperSlide className="swiper-slide">
                  <div className="testimonial-wrap text-center">
                    ...
                    <div className="content">
                      <p>"CarLot Agency actively encourage customers to leave reviews to help promote their products and services and to build trust with potential customers."</p>
                    </div>
