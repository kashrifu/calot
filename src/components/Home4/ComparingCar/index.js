...
function index() {
  ...
  return (
    <div className="home4-comparing-car-area pt-100 pb-100 mb-100"> 
            ...
            <Swiper {...slideSettings} className="swiper home4-latest-car-slider">
              <div className="swiper-wrapper">
                <SwiperSlide className="swiper-slide">
                  <div className="home4-compare">
                    <div className="compare-img">
                      <div className="single-img left">
                        <img src="assets/img/home4/compare-11.png" alt="" />
                      </div>
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="home4-compare">
                    <div className="compare-img">
                      <div className="single-img left">
                        <img src="assets/img/home4/compare-13.png" alt="" />
                      </div>
                      <div className="single-img right">
                        <img src="assets/img/home4/compare-14.png" alt="" />
                      </div>
                    </div>
                    <div className="compare-content">
                      <div className="content-top">
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="home4-compare">
                    <div className="compare-img">
                      <div className="single-img left">
                        <img src="assets/img/home4/compare-15.png" alt="" />
                      </div>
                      <div className="single-img right">
                        <img src="assets/img/home4/compare-16.png" alt="" />
                      </div>
                    </div>
                    <div className="compare-content">
                      <div className="content-top">
