...
function About() {
  ...
  return (
    <MainLayout>
              ...
              <div className="col-lg-12">
                <div className="welcome-wrap text-center">
                  <div className="section-title1 text-center wow fadeInUp" data-wow-delay="200ms">
                    ...
                    <h2>Welcome To CarLot</h2>
                  </div>
                  <div className="welcome-content wow fadeInUp" data-wow-delay="300ms">
                    <p>We're passionate car agency<br /> 
                      we're thrilled to have you join our community of automotive enthusiasts and professionals. Whether you're a passionate driver, a car owner, or someone who loves all things automotive, you've come to the right place.At CarLot, we strive to create a space where people can connect, share knowledge, and explore the exciting world of automobiles. From discussing the latest car models and technologies to sharing driving tips and tricks, we're here to fuel your love for everything on wheels.Feel free to ask any questions you have, seek advice, or simply engage in friendly conversations with fellow members. Our community is full of experts and enthusiasts who are eager to share their insights and experiences.
                      Buckle up and enjoy your journey with CarLot!</p>
                  </div>
        ...
        <div className="CarLot-gallery mb-100">
          <div className="container">
            <div className="row mb-50 wow fadeInUp" data-wow-delay="200ms">
              <div className="col-lg-12">
                <div className="section-title1 text-center">
                  <h2>CarLot Gallery</h2>
                </div>
              </div>
            </div>
                    ...
                    <div className="swiper-wrapper">
                      <SwiperSlide className="swiper-slide">
                        <div className="feedback-card">
                          ...
                          <p>CarLot-Agency to the actively encourage customers to leave
                      ...
                      <SwiperSlide className="swiper-slide">
                        <div className="feedback-card">
                          ...
                          <p>CarLot-Agency customer feedback is an invaluable source of
